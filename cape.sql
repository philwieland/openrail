...
('AK','Fire in freight yard / terminal (including private sidings, and stations Ð where it affects FOC services)'), 
...
('FI','Delay in running due to the incorrect operation of the on- board ETCS/ ERTMS equipment Ð i.e. wrong input by driver.'), 
...
('FP','Incorrect route taken or route wrongly challenged by driver, including SPADÕs'), 
...
('OD','Delayed as a result of Route Control directive'), 
...
('QP','Reactionary Delay to ÒPÓ coded Possession'), 
...
('RN','Passengers ÒforcingÓ connections between trains outside connectional allowances'), 
...
('TB','Train cancelled/delayed at Train OperatorÕs request'), 
...
('X1','Visibility in semaphore signalled areas, or special working for fog and falling snow implemented by Network Rail Ð in all signalling areas'), 
('X2','Severe flooding beyond that which could be mitigated on Network Rail infrastructure'), 
('X3','Lightning Strike Ð damage to protected systems.'), 
